...
import (
	...
	"github.com/Dtx-validator/dtx-node/contracts/staking"
	"github.com/Dtx-validator/dtx-node/crypto"
	"github.com/Dtx-validator/dtx-node/e2e/framework"
	stakingHelper "github.com/Dtx-validator/dtx-node/helper/staking"
	"github.com/Dtx-validator/dtx-node/helper/tests"
	txpoolOp "github.com/Dtx-validator/dtx-node/txpool/proto"
	...
	ibftManager := framework.NewIBFTServersManager(
		...
		func(i int, config *framework.TestServerConfig) {
			if i < numGenesisValidators {
				...
				dirPrefix := "dtx-edge-non-validator-"
